...
class UserMedicationDao(private val dataSource: DataSource) {
    ...
    suspend fun getUserMedicationByUserId(userId: String, secretKey: SecretKey): List<UserMedication> =
        withContext(Dispatchers.IO) {
            dataSource.connection.use { connection ->
    ...
    suspend fun getUserMedicationById(umId: String, secretKey: SecretKey): UserMedication =
        withContext(Dispatchers.IO) {
            dataSource.connection.use { connection ->
    ...
    suspend fun getTodayUserMedicationByUserId(userId: String, secretKey: SecretKey): List<UserMedication> =
        withContext(Dispatchers.IO) {
            dataSource.connection.use { connection ->
    ...
    suspend fun getUserMedicationHistory(userId: String, secretKey: SecretKey): List<UserMedication> =
        withContext(Dispatchers.IO) {
            dataSource.connection.use { connection ->
